var NAME_ID         = 0;	//技能名称
var USAGE_TYPE      = 1;	//使用类型：1技能，2HTB
var DAMAGE_TYPE     = 2;	//技能类型：1物理，2气功，3见SKILL_TYPE
var SKILL_TYPE      = 3;	//0~7
var LEVEL           = 4;	//技能等级
var TARGET_AREA     = 5;	//
var TARGET          = 6;	//
var MAX_TARGETS     = 7;	//AOE矩形范围人数，必须大于1
var AOE             = 8;	//
var AOE_RADIUS_1    = 9;	//圆形范围大小/矩形长
var AOE_RADIUS_2    = 10;	//圆形范围人数/矩形宽
var EFFECT_ID_1     = 11;	//技能效果1
var EFFECT_ID_2     = 12;	//技能效果2
var EFFECT_PERC_1   = 13;	//技能效果1加成类型：0数值，1百分比
var EFFECT_PERC_2   = 14;	//技能效果2加成类型：0数值，1百分比
var EFFECT_VAL_1    = 15;   //技能效果1值
var EFFECT_VAL_2    = 16;   //技能效果2值
var RP_ID_1         = 17;   //RP球1
var RP_ID_2         = 18;   //RP球2
var RP_ID_3         = 19;   //RP球3
var RP_ID_4         = 20;   //RP球4
var RP_ID_5         = 21;   //RP球5
var RP_ID_6         = 22;   //RP球6
var RP_VAL_1        = 23;   //RP球1值
var RP_VAL_2        = 24;   //RP球2值
var RP_VAL_3        = 25;   //RP球3值
var RP_VAL_4        = 26;   //RP球4值
var RP_VAL_5        = 27;   //RP球5值
var RP_VAL_6        = 28;   //RP球6值
var LEVEL_REQ       = 29;   //学习技能所需等级
var SP_COST         = 30;   //学习技能所需SP点
var SKILL_REQ_1     = 31;   //前置技能1
var SKILL_REQ_2     = 32;   //前置技能2
var SKILL_REQ_3     = 33;   //前置技能3
var SKILL_REQ_4     = 34;   //前置技能4
var EQUIP           = 35;   //发动技能需要的装备
var LP_COST         = 36;   //使用LP
var EP_COST         = 37;   //使用EP
var CAST_TIME       = 38;   //准备时间
var COOLDOWN        = 39;   //冷却时间
var DURATION        = 40;   //持续时间
var RANGE           = 41;   //使用距离
var DESCRIPTION_ID  = 42;   //技能描述
var NEXT_ID         = 43;   //下一级技能
var USABLE_STATE    = 44;
var URL_POS         = 45;
